# Graph Report - Selfup Ai  (2026-07-02)

## Corpus Check
- 183 files · ~183,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 571 nodes · 669 edges · 30 communities detected
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 171 edges (avg confidence: 0.8)
...
Cohesion: 0.11
Nodes (10): cleanupPlanTasks(), GET(), getDb(), POST(), DELETE(), GET(), getDb(), PATCH() (+2 more)

### Community 5 - "Community 5"
Cohesion: 0.15
Nodes (18): buildLiveStateBlock(), DELETE(), fetchConversationHistory(), GET(), POST(), clearUserMemory(), embedAndStoreMessage(), extractAndSaveMemory() (+10 more)

### Community 6 - "Community 6"
Cohesion: 0.17
Nodes (18): POST(), executeActions(), executeConfirmedAction(), getServiceClient(), handleCreateDaily(), handleCreateHabit(), handleCreateTodo(), handleFitnessInterviewStart() (+10 more)
...
- **Thin community `Community 22`** (5 nodes): `getDb()`, `POST()`, `route.ts`, `route.ts`, `route.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (4 nodes): `fetchDashboardData()`, `handleGeneratePlan()`, `handleOpenAiModal()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (4 nodes): `FitnessSessionPage()`, `createServerClient()`, `page.tsx`, `supabase-server-user.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (3 nodes): `fetchMetrics()`, `handleSubmit()`, `BodyView.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `SelfUp Architecture`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Frontend Web (Next.js)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `PostgreSQL Database Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `verifyAuth()` connect `Community 0` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 18`, `Community 22`, `Community 26`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 5` to `Community 0`, `Community 1`, `Community 6`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `calculateTaskXp()` connect `Community 7` to `Community 4`?**
