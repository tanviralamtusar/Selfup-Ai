import type { MuscleValue } from "../muscleTypes";
...
export const AbdominalsGroup = ({
  ...
  onToggleMuscle: (muscle: MuscleValue) => void;
  getMuscleClasses: (muscle: MuscleValue) => string;
}) => {
  return (
    <g className="group cursor-pointer" onClick={() => onToggleMuscle("ABDOMINALS")}>
      <path
      ...
      {/* Path 108 */}
      <path
        className={getMuscleClasses("ABDOMINALS")}
        d="M 124.01,216.93
